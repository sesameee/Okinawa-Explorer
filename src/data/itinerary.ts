...
export const ITINERARY: ItineraryData = {
  ...
  days: [
    ...
    },
    {
      ...
      title: "名護鳳梨園 + 牛排午餐 + 飯店玩水日",
      baseHotel: { query: "BEB5 沖繩瀨良垣", label: "BEB5 沖繩瀨良垣", type: "hotel" },
      stops: [
        { idx: 0, id: "hotel_naha1", name: "BEB5 沖繩瀨良垣（飯店早餐）", type: "hotel", queryChoices: ["BEB5 沖繩瀨良垣"], mapsUrl: mapsQueryLink("BEB5 沖繩瀨良垣"), schedule: { start: "08:30", end: "10:00", isWindow: false } },
        { idx: 1, id: "pineapple_park", name: "名護鳳梨園", type: "attraction", queryChoices: ["ナゴパイナップルパーク", "名護鳳梨園"], mapsUrl: mapsQueryLink("ナゴパイナップルパーク"), schedule: { start: "10:30", end: "11:45", isWindow: true }, alternatives: ["Nago Pineapple Park"] },
        { idx: 2, id: "dive_steak", name: "潛水員牛排（午餐）", type: "meal", queryChoices: ["潛水員牛排 名護"], mapsUrl: mapsQueryLink("潜水員牛排 名護"), schedule: { start: "12:00", end: "14:00", isWindow: true }, alternatives: ["名護 ステーキレストラン 潛水員"] },
        {
          idx: 3,
          id: "supermarket_3a",
          name: "3A 超市（買和牛）",
          type: "meal",
          queryChoices: ["3A スーパー 1 Chome-2-13 Agarie, Nago, Okinawa 905-0021日本"],
          mapsUrl: mapsQueryLink("3A スーパー 1 Chome-2-13 Agarie, Nago, Okinawa 905-0021日本"),
          schedule: { start: "14:15", end: "15:30", isWindow: true },
          alternatives: ["3A スーパー 名護", "エースワン 名護 東江"],
          note: "採購沖繩和牛、伴手禮",
        },
        {
          idx: 4,
          ...
          name: "回飯店玩水",
          type: "hotel",
          queryChoices: ["BEB5 沖繩瀨良垣"],
          mapsUrl: mapsQueryLink("BEB5 沖繩瀨良垣"),
          schedule: { start: "16:00", end: "20:00", isWindow: false },
          note: "回飯店泳池放電",
        },
      ],
      order: [0, 1, 2, 3, 4],
      travelMode: ROUTE_MODE_BY_DAY[3],
      staticLegs: { "0-1": { minutes: 30, distanceKm: 0 }, "1-2": { minutes: 15, distanceKm: 0 }, "2-3": { minutes: 5, distanceKm: 0 }, "3-4": { minutes: 30, distanceKm: 0 } },
    },
    {
      dayNumber: 4,
